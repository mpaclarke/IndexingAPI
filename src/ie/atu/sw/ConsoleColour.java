 ...
 * @since JavaSE-19
 * 
 *        Asset stripped from Healy(2022).
 * 
 *        ANSI escape sequences are a standard for controlling cursor location,
 *        colour, font styling, and other options on DOS, Mac and Linux
 *        terminals. The ANSI escape codes are formatted as follows:
 * 
 *        [<PREFIX>];[<COLOR>];[<TEXT DECORATION>]
 * 
 *        See https://en.wikipedia.org/wiki/ANSI_escape_code for a decent
 *        description.
 */
